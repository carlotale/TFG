...
class AIAgent:
    ...
    def get_response(self, output_format: type[BaseModel]) -> Iterator[str]:
        ...
        """
        try:
            response_stream = self.client.chat(  # pyright: ignore[reportUnknownMemberType]
                model=self.model,
    ...
    def get_param_count(self) -> int:
        ...
        try:
            return cast(int, cast(dict[str, Any], self.client.show(self.model).modelinfo)["general.parameter_count"])
        except Exception as e:
